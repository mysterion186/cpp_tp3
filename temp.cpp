...
void sorted_container(T & v){
    for (auto it_1 = v.begin();it_1!=v.end();++it_1){
        auto index = distance(v.begin(),it_1);
        for (auto it_2 = v.begin()+index+1;it_2<v.end();++it_2){
...
// fonction pour afficher les conteneurs 
template <typename T>
void display(T& v){
...
int main(int argc, char** argv){
    ...
    cout<< vect[0].compare("i")<<endl;
    stringstream convert_ss; 
    string vect_string;
    convert_ss << vect[0];
    convert_ss>>vect_string;
    string str1 = "i"; 
    string str2 = "i"; 
    cout<<"test final"<<endl;
    cout<< vect_string.compare(str2)<<endl;
    cout<<"test final 1 "<<endl;
    cout<< vect_string.compare("i")<<endl;
    ...
    // }
    // // cas string
    // else if (vect[0].compare("str")){
    //     if (vect[1].compare("v")){
    //         cout<<"travaille avec vector string"<<endl;
    //         vector<string> temp;
    //         write(vect,argv[1],temp);
    //     }
    //     else if (vect[1].compare("d")){
    //         cout<<"travaille avec deque string"<<endl;
    //          deque <string> temp; 
    //          write(vect,argv[1],temp);
    //     }
    //     else if (vect[1]=="l"){
